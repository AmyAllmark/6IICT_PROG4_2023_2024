...
"""
print(weer_data['voorspelling']["overmorgen"]["overig"][0])# kijk na
...
print(weer_data["huidig_weer"]["temp"])
...
"""
for dag,dagvoorspelling in weer_data["voorspelling"].items() :
    temp=dagvoorspelling["hoge_temp"]
    print(f"-{dag}: {temp}°C")
