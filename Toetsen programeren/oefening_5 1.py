...
while True: # Start de app.
    ...
    if optie == "1":   # Toon details van opgevraagd boek.
        ...
        """
        titel=(str(input("geef een titel van een boek in:")))
        if titel in catalogus:
            print(f"het boek {titel}is geschreven door {catalogus[titel]['auteur']}en de datum is{catalogus[titel]['datum']}")
        
        else: 
            print ("het boek bestaat niet")
        ...
        """
        titel_oef2= (str(input("geef een titel in van een boek: ")))
        auteur_oef2= (str(input("geef een titel in van een boek: ")))
